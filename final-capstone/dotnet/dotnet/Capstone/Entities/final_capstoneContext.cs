...
namespace Capstone.Entities
{
    public partial class final_capstoneContext : DbContext
    {
        ...
        public virtual DbSet<WorkerInformation> WorkerInformation { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK_worker_id");

                entity.ToTable("worker_information");
                ...
                entity.HasOne(d => d.User)
                    .WithOne(p => p.WorkerInformation)
                    .HasForeignKey<WorkerInformation>(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_worker_user_id");
            });
        }
    }
}
