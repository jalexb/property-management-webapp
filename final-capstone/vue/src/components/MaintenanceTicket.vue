...
<template>
  <div class="maintenance-page">
    ...
    <p>
      We're sorry for any inconveniences that led you here. We will let you know
      the date the maintenance staff will be coming. Please note that you are
      allowing our staff to enter your home to complete the service.
    </p>
    <p>
    ...
    <v-form>
      <v-text-field v-model="User.fullName" label="Name" :counter="40" required>
      </v-text-field>
      ...
      <v-textarea v-model="ticket.Request_Info" label="Maintenance Description">
      </v-textarea>
